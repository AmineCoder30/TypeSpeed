  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-10 -left-10 w-40 h-40 bg-gradient-to-r from-blue-500/10 to-purple-500/10 dark:from-blue-500/20 dark:to-purple-500/20 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute -bottom-10 -right-10 w-32 h-32 bg-gradient-to-r from-pink-500/10 to-yellow-500/10 dark:from-pink-500/20 dark:to-yellow-500/20 rounded-full blur-3xl animate-pulse delay-1000"></div>
        <div className="absolute top-1/2 -left-5 w-20 h-20 bg-gradient-to-r from-green-500/10 to-cyan-500/10 dark:from-green-500/20 dark:to-cyan-500/20 rounded-full blur-2xl animate-pulse delay-500"></div>
      </div>
                ...
                <Button
                  ...
                  className={cn(
                    ...
                    testMode === mode.id
                      ...
                      : `${mode.bgColor} ${mode.hoverColor} text-muted-foreground hover:text-foreground border border-transparent hover:border-border`,
                  )}
